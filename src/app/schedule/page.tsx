...
import { schedules, upcomingCohorts, type ScheduleType } from "@/data/scheduleData";
import Image from "next/image";

// Import images - note: these might need to be in public/ or handled as static imports
...
const scheduleImages: Record<ScheduleType, any> = {
  morning: morningImg,
  evening: eveningImg,
  weekend: weekendImg,
};
