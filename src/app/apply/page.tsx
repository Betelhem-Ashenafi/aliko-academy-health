            ...
            <Card className="max-w-2xl mx-auto text-center overflow-hidden animate-fade-in">
              ...
              <CardContent className="pt-12 pb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  <Button asChild variant="outline"><Link href="/programs">Explore Programs</Link></Button>
                  <Button asChild className="bg-accent text-accent-foreground hover:bg-accent/90"><Link href="/">Return to Home</Link></Button>
                </div>
              </CardContent>
            </Card>
          </div>
                      ...
                      <div className="bg-muted/50 rounded-xl p-4 space-y-3">
                        <FormField control={form.control} name="termsAccepted" render={({ field }) => (
                          <FormItem className="flex flex-row items-start space-x-3 space-y-0"><FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} className="mt-0.5" /></FormControl>
                            <div className="space-y-1 leading-none"><FormLabel className="font-normal text-sm">I agree to the <Link href="/policies" className="text-primary underline hover:text-primary/80">Terms of Service and Privacy Policy</Link> *</FormLabel><FormMessage /></div></FormItem>
                        )} />
