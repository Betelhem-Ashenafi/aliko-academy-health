...
export default function ExamPrepDetailPage() {
  ...
  useEffect(() => {
    if (!program) {
      // router.replace("/exam-prep"); // Handled below with a "not found" state for better UX
    }
  }, [program]);
    ...
    return (
      <Layout>
        <div className="container-academy py-16 text-center">
          ...
          <Button asChild>
            <Link href="/exam-prep">View All Exam Prep Programs</Link>
          </Button>
        </div>
      </Layout>
    );
              ...
              <Card className="sticky top-24 shadow-xl border-t-4 border-t-accent">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    Questions? <Link href="/contact" className="text-accent hover:underline font-medium">Contact us</Link>
                  </p>
                </CardContent>
              </Card>
            </div>
