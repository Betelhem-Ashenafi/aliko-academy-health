            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <Card className="border-border/50 shadow-sm">
                ...
                <CardContent className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="org-website" name="org-website" placeholder="https://" type="url" className="h-11 text-base" />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2 sm:col-span-2">
                    ...
                    <Input id="org-address" name="org-address" placeholder="Street, City, State, ZIP" required className="h-11 text-base" />
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="num-students" name="num-students" type="number" min="1" placeholder="e.g., 5" required className="h-11 text-base" />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="preferred-start" name="preferred-start" type="month" min="2026-03" className="h-11 text-base" />
                    </div>
                  </div>
              ...
              <Card className="border-border/50 shadow-sm">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="requirements" name="requirements" rows={3} placeholder="e.g., Custom schedule, on-site training..." className="text-base" />
                  </div>
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div className="space-y-2">
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-3 cursor-pointer">
                  <Checkbox id="confirm-auth" required className="mt-0.5" />
                  <Label htmlFor="confirm-auth" className="text-xs text-muted-foreground leading-relaxed font-normal">
