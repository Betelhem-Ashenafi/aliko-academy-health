  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold font-academy">Content Blocks</h1>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4">
            ...
            <Button onClick={handleSave} className="w-full font-bold"><Save className="mr-2 h-4 w-4" />{editing ? "Update" : "Create"}</Button>
          </div>
        </DialogContent>
      </Dialog>
    </div>
